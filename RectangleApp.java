...
public class RectangleApp {
	...
	public static void main( String[] args ) {
		...
		System.out.println("Scaled myRect1 - Width: " + myRect1.width + ", Height: " + myRect1.height);
		System.out.println("Scaled myRect2 - Width: " + myRect2.width + ", Height: " + myRect2.height);
		System.out.println("Scaled myRect3 - Width: " + myRect3.width + ", Height: " + myRect3.height);
